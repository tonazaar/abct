...
var Transaction = /** @class */ (function () {
    ...
    Transaction.prototype.details = function (txid) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios_1.default.get(this.restURL + "transaction/details/" + txid)];
                    case 1:
                        response = _a.sent();
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, axios_1.default.post(this.restURL + "transaction/details", {
                                txids: txid
                            })];
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
                    case 4: throw new Error("Input txid must be a string or array of strings.");
                    case 5:
                        error_1 = _a.sent();

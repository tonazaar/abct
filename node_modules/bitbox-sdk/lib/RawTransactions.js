            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, axios_1.default.post(this.restURL + "rawtransactions/decodeRawTransaction", {
                                hexes: hex
                            })];
                    case 3:
                        response = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, axios_1.default.post(this.restURL + "rawtransactions/decodeScript", {
                                hexes: script
                            })];
                    case 3:
                        response = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, axios_1.default.post(this.restURL + "rawtransactions/getRawTransaction", {
                                txids: txid,
                                verbose: verbose
                            })];
                    case 3:
